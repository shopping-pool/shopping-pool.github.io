...
function try1() {
    ...
    //prod_name
    var prod_name = '<form class = "dataform"><label class = "label" > Product Name</label><input type="text" class = "text" id="prod_name" placeholder="(enter in the format Brand-producttype eg lotto-shoes)" required ><br>';
    //price and qty
    var qty_price = '<label class = "label" > Quantity</label><input type="text" class = "text" id="qty" placeholder="Enter qty available for respective sizes/weights in same format eg 3,4,5" required ><br><label class = "label">Prices</label><input type="text" class = "text" id="prices" placeholder="Enter prices for respective sizes/weights in same format eg 300,400,500" required ><br>';
    //image
    var image = '<label class = "label" >Product Image</label><input type="file" id = "photo" required ><br>';
    //size
    var size = '<label class = "label" >Size</label><input type="text" class = "text"  id="size" placeholder="Enter sizes available separated by comma" required ><br>';
    //gender
    var gender = '<label class = "label" >Gender</label><input type="radio" name="gender" value="male" required > Male<input type="radio" name="gender" value="female"> Female<input type="radio" name="gender" value="both"> Both<br>';
    //color
    var color = '<label class = "label" >Color</label><input type="text" class = "text"  id="color" placeholder="Enter colors available separated by comma" required ><br>';

    //Material
    var material = '<label class = "label" >Material</label><input type="text" class = "text"  id="material" placeholder="Material" required ><br>';

    // weight
    var weight = '<label class = "label" >Weight</label><input type="text" class = "text"  id="weight" placeholder="Enter weights available separated by comma" required><br>';
    //water ressistance
    var water_ressistance = '<label class = "label" >Water Ressistance</label><input type="radio" name="water_ressistance" value="yes" required > Yes<input type="radio" name="water_ressistance" value="No"> No<br>';
    //edition
    var edition = '<label class = "label" >Edition</label><input type="radio" name="edition" value="hardcover" required> hardcover<input type="radio" name="edition" value="paperback"> paperback<br>';
    var submit = '<input class = "form submit" type="submit" onclick="add_product()" value="Submit"><form>';
